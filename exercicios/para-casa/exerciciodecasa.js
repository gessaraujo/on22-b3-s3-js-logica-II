...
function strng(strg1, strg2) {
  if (strg1.length === strg2.length) {
    return strg1 + strg2;
  } else {
    return strg1.length < strg2.lenght ? strg1 : strg2;
  }
}

console.log(strng("Gessica", "Gabi"));
...
function frase(strg) {
  if (strg.includes("a" || "A")) {
    return "Yes. Now have a break";
  } else {
    return "No";
  }
}

console.log(frase("Have a break"));
